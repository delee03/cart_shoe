...
const ShoeItem = ({ shoeItem, index, addToCart }) => {
    ...
    return (
        ...
        >
            ...
            <div className="px-5 py-8" style={{ marginTop: "-50px" }}>
                <a href="#">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <span className="bg-purple-300 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-purple-300 dark:text-blue-800 ms-3">
                        5.0
                    </span>
                </div>
